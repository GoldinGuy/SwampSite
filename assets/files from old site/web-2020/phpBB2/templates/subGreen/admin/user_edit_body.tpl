...
<form action="{S_PROFILE_ACTION}" {S_FORM_ENCTYPE} method="post"><table width="98%" cellspacing="1" cellpadding="4" border="0" align="center" class="forumline">
	...
	<tr> 
	  ...
	  <td class="row2"> 
		<input class="post" type="text" name="username" size="35" maxlength="40" value="{USERNAME}" autocomplete="off" />
	  </td>
	</tr>
	<tr> 
	  <td class="row1"><span class="gen">{L_EMAIL_ADDRESS}: *</span></td>
	  <td class="row2"> 
		<input class="post" type="text" name="email" size="35" maxlength="255" value="{EMAIL}" autocomplete="off" />
	  </td>
	</tr>
	<tr> 
	  ...
	  <td class="row2"> 
		<input class="post" type="password" name="password" size="35" maxlength="32" value="" autocomplete="off" />
	  </td>
	</tr>
	<tr> 
