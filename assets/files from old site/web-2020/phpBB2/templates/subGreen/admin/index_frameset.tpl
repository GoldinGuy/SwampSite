...
<noframes>
	<body bgcolor="#FFFFFF" text="#000000">
		...
		<p>You can try <a href="http://www.getfirefox.com">Mozilla Firefox</a> or <a href="http://www.opera.com">Opera</a> which are both free and do support frames.</p>
		<p>Thank you for using subGreen for phpBB 2</p>
	</body>
</noframes>
</html>
